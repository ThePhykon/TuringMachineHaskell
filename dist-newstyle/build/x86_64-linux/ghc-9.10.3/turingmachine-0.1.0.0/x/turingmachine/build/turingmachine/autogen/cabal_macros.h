...
#ifndef VERSION_turingmachine
#define VERSION_turingmachine "0.1.0.0"
#endif /* VERSION_turingmachine */
#ifndef MIN_VERSION_turingmachine
#define MIN_VERSION_turingmachine(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_turingmachine */
...
#define CURRENT_COMPONENT_ID "turingmachine-0.1.0.0-inplace-turingmachine"
